...
//getters and setters for the head property
Object.defineProperty(Token.prototype, 'head',
    {
        get: function() { console.warn("Warning: This property is deprecated and will be modified in future versions."); return this._head; },
        set: function(newVal) { console.warn("Warning: This property is deprecated and will be modified in future versions."); this._head = newVal; }
    }
);
//getters and setters for the deps property
Object.defineProperty(Token.prototype, 'deps',
    {
        get: function() { console.warn("Warning: This property is deprecated and will be modified in future versions."); return this._deps; },
        set: function(newVal) { console.warn("Warning: This property is deprecated and will be modified in future versions."); this._deps = newVal; }
    }
);
